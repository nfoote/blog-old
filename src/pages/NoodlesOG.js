...
import { LayerMaterial, Depth, Fresnel, Noise, Base } from 'lamina/vanilla'
...
const material = new LayerMaterial({
  layers: [
    ...
    new Depth({ colorA: 'purple', colorB: colorB, alpha: 0.9, mode: 'add', near: 3, far: 2, origin: [1, 1, 1] }),
    new Fresnel({ mode: 'add', color: fresnel, intensity: 0.3, power: 0.2, bias: 0.0 }),
